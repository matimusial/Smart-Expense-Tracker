if __name__ == "__main__":
    ...
    # Usuń yolo_data_tmp, jeśli istnieje
    if os.path.exists(output_dir):
        shutil.rmtree(output_dir)
        print(f"Usunięto istniejący folder {output_dir}.")
    ...
    run(
        ...
        name="yolo_640_16_50_yolov5s"         # Nazwa treningu
    )

    # Usunięcie tymczasowego folderu po zakończeniu treningu
    shutil.rmtree(output_dir)
